...
<a href="{{ $post->url }}" {{ $attributes->class(['mb-16 md:mb-0']) }}>
    <x-image conversion="3x2" :image="$post->image" class="block h-auto w-full" />
    <div class="{{ $wide ? 'p-2 md:p-8 xl:p-12  justify-center max-w-lg' : 'max-w-xs flex-grow' }} flex flex-col">
