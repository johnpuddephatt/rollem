<header id="main-header" x-data="{ menuOpen: false }" class="fixed top-0 left-0 z-20 w-full py-12 text-white">
    <div class="container flex flex-row items-start justify-between">
        ...
        <nav :class="!menuOpen && 'max-lg:translate-x-full'"
            class="inset-0 z-40 flex flex-col items-start gap-12 text-lg font-semibold transition max-lg:absolute max-lg:h-screen max-lg:justify-center max-lg:bg-black max-lg:p-8 lg:flex-row">
