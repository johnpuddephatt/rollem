<div class="relative overflow-hidden">
    <div class="grid-cols-3 lg:container lg:grid">
        ...
        <div
            class="{{ $layout->reverse ? 'order-first' : '' }} relative py-16 before:absolute before:left-0 before:top-0 before:bottom-0 before:-z-10 before:block before:w-[99999px] before:bg-gray lg:px-8">
